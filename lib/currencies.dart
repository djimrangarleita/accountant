/// All supported currency codes with display names (from Open Exchange Rates).
/// Top currencies (USD, XAF, KES) are listed first; the rest are alphabetical by code.
const List<({String code, String name})> kAllCurrencies = [
